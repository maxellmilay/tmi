...
export default function History() {
  return (
    <>
      <Section
        id="history"
        className="flex items-end h-[25vh] sm:h-[35vh] md:h-[70vh] bg-[url('/images/about/mobile-history-header.png')] md:bg-[url('/images/about/history-header.png')] no-repeat bg-cover bg-center"
      >
      ...
      <Section className="flex flex-col md:flex-row relative justify-start md:justify-start items-center h-[55vh] md:h-[80vh] bg-[url('/images/about/history-bg-1.png')] no-repeat bg-cover bg-center px-10">
        <Image
          src={HistoryPic1}
          alt="1st history pic"
          className="w-[80vw] h-[65vw] md:w-[50vw] md:h-[80vh] object-cover absolute -top-8 md:bottom-10"
        />
        <div className="flex mt-[65vw] md:mt-0 justify-center md:justify-end md:items-center w-full h-full">
          <p className="text-black h-[35vw] md:h-fit w-[80vw] md:max-w-[35vw] text-justify">
      ...
      <Section className="flex md:items-center justify-center md:justify-start h-[40vh] sm:h-[35vh] px-12 sm:px-20 bg-[url('/images/about/mobile-history-bg-2.png')] md:bg-[url('/images/about/history-bg-2.png')] no-repeat bg-cover bg-center">
        <p className="md:max-w-[40vw] text-lg sm:text-2xl text-justify leading-8 md:leading-10 mt-24 md:mt-0">
      ...
      <Section className="flex relative justify-center bg-[url('/images/about/history-bg-3.png')] no-repeat bg-cover bg-center">
        <Image
          src={HistoryPic2}
          alt="2nd history pic"
          className="h-[60vw] md:h-[40vw] w-[80vw] md:[65vw] object-cover absolute -top-24 sm:-top-32 md:-top-10"
        />
