...
export default function Home() {
  ...
  return (
    <>
      ...
      <Layout>
        <Section className="h-screen bg-[url('/images/home/latest-sermon.jpg')] no-repeat bg-cover bg-bottom px-6 sm:px-10 pt-[22rem] sm:pt-[20rem] md:pt-[16rem] lg:pt-[20rem]">
        ...
        <Section className="h-screen bg-[url('/images/home/welcome-to-tmi.jpg')] no-repeat px-6 sm:px-10 bg-cover bg-top p-5">
