        ...
        <>
            ...
            <Section>
                <div className="pt-72">
                    ...
                    <p className="font-bold text-7xl mb-8 mt-5">
                        The Premise of the Promise <br /> of a Happy New Year
                    </p>
                    <button className="bg-tmi-yellow py-1.5 px-7 font-bold rounded-3xl mr-3">
                        Watch Now
                    </button>
            ...
            <Section>
                <div className="mx-5 pt-5">
                    ...
                    <div className="flex flex-col items-center mt-10">
                        ...
                        <p className="font-bold text-7xl mb-3">
                            TMI Fellowship
                        </p>
                        <p className="text-tmi-yellow font-thin text-2xl mb-20">
