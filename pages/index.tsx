    ...
    <>
      ...
      <Layout>
        ...
        <Section className="h-[100dvh] flex flex-col-reverse sm:flex-row-reverse">
          ...
          <div className="flex h-full sm:w-1/2 overflow-hidden">
            <div className="h-full w-full bg-[url('/images/home/rooted-pic.webp')] bg-cover bg-top sm:bg-center scale-105 hover:scale-100 hover:duration-500 transition-all" />
          </div>
        </Section>
      </Layout>
    </>
